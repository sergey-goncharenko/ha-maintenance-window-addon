...
Maintenance Window logs installed Supervisor add-ons on startup when `list_addons_on_startup` is enabled. Copy slugs from lines like:
...
The add-on also writes a copyable table to:
